...
from titlecase import titlecase, set_small_word_list, create_wordlist_filter
...
def test_custom_abbreviations():
    with tempfile.NamedTemporaryFile(mode='w') as f:
        ...
        assert titlecase('sending UDP packets over PPPoE works great', callback=create_wordlist_filter(f.name)) == 'Sending UDP Packets Over PPPoE Works Great'
